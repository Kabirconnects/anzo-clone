...
function page2() {
  ...
  return (
    <>
      <div className="bg-white text-black text-center mt-6">
        <h3 className="text-gray-500 text-[1.5vw] font-[anzo4]">
          © anzo.studio 2024 | designed and developed
        </h3>
      </div>

      <div id="section2" className="bg-white text-center p-20">
      ...
      <div className="flex justify-center items-start w-[100%] mt-[3vw]">

      <div className="w-[25%] h-[0.3vh] bg-black "></div>
